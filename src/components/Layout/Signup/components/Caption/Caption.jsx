		...
		<>
			<div className='caption'>
				...
				<div className='caption__item'>
					<div>
						<svg width='26' height='26' className='svg-icon' fill='#0095ff'>
							<path
								opacity='.5'
					...
					<div className='caption__item__txt'>Get unstuck — ask a question</div>
				</div>
				<div className='caption__item'>
					<div>
						<svg width='26' height='26' fill='#0095ff'>
					...
					<div className='caption__item__txt'>
				...
				<div className='caption__item'>
					...
					<div className='caption__item__txt'>Earn reputation and badges</div>
				</div>
				<div className='caption__item'>
					<div>
						...
						Try a{' '}
						<a
							href='https://stackoverflow.com/teams?utm_source=so-owned&utm_medium=product&utm_campaign=public-sign-up&utm_content=teams'
							className='link'>
